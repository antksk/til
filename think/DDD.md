# DDD
* 참고 : 
  - 조용호 님의 애플리케이션 [애플리케이션 아키텍쳐와 객체지향][애플리케이션 아키텍쳐와 객체지향] 내용
...
* 데이터 기반 설계가 아닌, 상호 영향을 받는 domin들과의 관계를 설계하는 방식으로<br/>
* 쉽게 애기 해서, 무지 수정하지 말고, 관련된 domin에 할당된 책임들만 손보면 됨
...
> 유효성 검사, 계싼, 파생 등이 포함된 복잡하고, 끊임없이 변하는<br/>
